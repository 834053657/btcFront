        ...
        <Col span={14} className={classNames(className, styles.form)}>
          ...
          <Form hideRequiredMark onSubmit={this.handleSubmit}>
            ...
            <FormItem {...formItemLayout} label="手续费">
              ...
              <Button type="primary" loading={feeLoading} style={{marginLeft: 15}} onClick={this.handleGetFee}>获取手续费</Button>
            </FormItem>
          ...
          <Card  title={<span>帮助 <Icon type="question-circle" /></span>} >
            <Collapse className={styles.collapse} defaultActiveKey={['1']} >
              ...
              <Panel header="退款和支出" key="3" style={customPanelStyle}>
                <p>从utomarket的钱包发送资金时，会在您的余额中预留和扣除比特币网络转账费。 与其他utomarket用户的钱包进行交易免费。</p>
              </Panel>
            </Collapse>
          </Card>
        </Col>
