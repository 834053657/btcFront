...
class RechargeForm extends Component {
  ...
  render() {
    const { className, form, rechargSubmitting, feeLoading, currentUser, blockConfirmFee={} } = this.props;
        ...
        <Col span={14} className={classNames(className, styles.form)}>
          ...
          <Form hideRequiredMark onSubmit={this.handleSubmit}>
            ...
            <FormItem {...formItemLayout} label="费率">
              ...
              })(<Slider tipFormatter={this.formatter} step={1} max={maxBlock.count} min={minBlock.count} />)}
            </FormItem>
