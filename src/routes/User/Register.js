...
const infoMsg = {
  terms: {
    title: '服务条款',
    content: '请仔细阅读这些服务条款，通过点击“创建帐户”按钮或通过访问或使用本服务，您同意遵守本条款及所有附加条款。如果您不同意受本条款的约束，请勿访问本网站或使用本服务。\n' +
    '\n' +
      ...
      <div className={styles.main}>
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem>
            ...
            <a onClick={this.handleShowInfo.bind(this, 'terms')}>《服务条款》</a> <a onClick={this.handleShowInfo.bind(this, 'disclaimer')}>《免责申明》</a>
          </FormItem>
