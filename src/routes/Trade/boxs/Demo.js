...
//       this.scrollTop =
//         this.listComponent.props.scrollTop == ramdomLargeNumber
//           ? ramdomLargeNumber + 1
//           : ramdomLargeNumber;
//     } else {
//       if (this.props.list.length && nextProps.list[0] != this.props.list[0]) {
//         this.scrollTop =
//           addedHeight(nextProps.list.length - this.props.list.length - 1, nextProps.rowHeight) +
//           this.scrollTop;
...
//       isScrolling,
//       isVisible,
//       overFlow: this.clientHeight < this.scrollHeight,
//       index,
//       ...rest,
//     });
//   }
