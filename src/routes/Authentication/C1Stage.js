...
@Form.create()
export default class AuthenticationPage extends PureComponent {
  static state = {};
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem {...formItemLayout} label="证件类型">
          {getFieldDecorator('card_type', {
            initialValue: default_card_type,
          })(
        ...
        <FormItem {...formItemLayout} label="真实姓名">
          ...
          })(<Input placeholder="请输入与证件信息一致的姓名" />)}
        </FormItem>
        <FormItem {...formItemLayout} label="证件号码">
          ...
          })(<Input placeholder="请输入与证件信息一致的证件号码" />)}
        </FormItem>
